...
prompt = PromptTemplate(template='you are RAG Based Assistant answer the question from the given context.\n\n\
Question:\n {user_query}\n\n\
...
query_content_chain = RunnableParallel({'user_query': RunnablePassthrough(),
